      ...
      <div className="w-full flex justify-between pb-10 border-b border-light-gray">
        <div className="w-4/12 flex flex-col gap-32">
          ...
          <div className="flex gap-4">
            <div className="p-3 rounded-full bg-black-400 w-12 h-12 flex justify-center items-center">
        ...
        <ul>
          <li className="text-[22px] mb-[25px] font-semibold">Want to work with us?</li>
          <li className="font-[500] text-[black-400] my-4 text-[18px]">
          ...
          <li className="font-[500] text-[black-400] my-4 text-[18px]">
            <a href="#url">55/53 Jay Path Apt. 908</a>
          </li>
        </ul>
      </div>
