          ...
          <div className="flex flex-col gap-7">
            <div className="flex place-items-center gap-5">
              ...
              <div>
                ...
                <p className="text-[18px] md:text-[20px] text-gray-light">bitnbyt@gmail.com</p>
              </div>
            </div>
            <div className=" flex place-items-center gap-5" >
              <div className="bg-purple w-[70px] h-[70px] lg:w-[80px] lg:h-[80px] rounded-full flex justify-center items-center">
              ...
              <div>
                <h3 className="text-[18px] md:text-[20px] font-bold">Phone support</h3>
                <p className="text-[18px] md:text-[20px] text-gray-light">+91 3448835234</p>
              </div>
            </div>
            <div className=" flex place-items-center gap-5">
              <div className="bg-purple w-[70px] h-[70px] lg:w-[80px] lg:h-[80px] rounded-full flex justify-center items-center">
              ...
              <div>
                <h3 className="text-[18px] md:text-[20px] font-bold">Address</h3>
